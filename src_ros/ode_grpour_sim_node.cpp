...
*/
//-------------------------------------------------------------------------------------------
#include "ay_sim/ode_grpour_sim.h"
#include "ay_sim_msgs/ODEConfig.h"
#include "ay_sim_msgs/ODESensor.h"
#include "ay_sim_msgs/ODEViz.h"
#include "ay_sim_msgs/ODEVizPrimitive.h"
#include "ay_sim_msgs/ODEGetConfig.h"
#include "ay_sim_msgs/ODEReset2.h"
//-------------------------------------------------------------------------------------------
#include <ros/ros.h>
...
void OnSensingCallback(const ode_pour::TSensors1 &sensors)
{
  ...
  ay_sim_msgs::ODESensor sensors_msg;
...
bool GetConfig(ay_sim_msgs::ODEGetConfig::Request &req, ay_sim_msgs::ODEGetConfig::Response &res)
{
  using namespace ode_pour;
  ay_sim_msgs::ODEConfig &msg(res.config);
  msg.RcvPos.resize(3);
...
bool ResetSim2(ay_sim_msgs::ODEReset2::Request &req, ay_sim_msgs::ODEReset2::Response &res)
{
  using namespace ode_pour;
  std::cerr<<"Resetting simulator..."<<std::endl;
  const ay_sim_msgs::ODEConfig &msg(req.config);
...
int main(int argc, char**argv)
{
  ...
  PFlowPub= &flow_pub;
  ros::Publisher sensors_pub= node.advertise<ay_sim_msgs::ODESensor>("sensors", 1);
